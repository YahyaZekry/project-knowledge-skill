...
Grab [`project-knowledge.skill`](project-knowledge.skill) and install it:
...
```
skills/project-knowledge/SKILL.md   The skill source — edit this
skills/project-knowledge/README.md  Skill-level docs
project-knowledge.skill             Generated bundle — rebuild with ./build.sh
```
...
Made by [Yahya Zekry](https://github.com/YahyaZekry). See [SKILL.md](skills/project-knowledge/SKILL.md) for the full skill definition.
